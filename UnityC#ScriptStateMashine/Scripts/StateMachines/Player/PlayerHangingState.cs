...
public class PlayerHangingState : PlayerBaseState
{
    ...
    private readonly int HangingHash = Animator.StringToHash("Hanging2");
    ...
    {
        if(stateMachine.InputRead.MovementValue.y > 0f)
        {
            stateMachine.SwitchState(new PlayerPullUpState(stateMachine));
        }
        else if(stateMachine.InputRead.MovementValue.y <0f)
        {
