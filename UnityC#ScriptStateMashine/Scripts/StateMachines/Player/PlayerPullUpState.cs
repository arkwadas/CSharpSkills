...
public class PlayerPullUpState : PlayerBaseState
{
    ...
    private readonly Vector3 Offset = new Vector3(0f, 2f, 0.5952f /*2.325f, 0.65f*/);
    private const float CrossFadeDuartion = 0.1f;
    public PlayerPullUpState(PlayerStateMachine stateMachine) : base(stateMachine)   {    }

    public override void Enter()
    {
        stateMachine.Animator.CrossFadeInFixedTime(PullUpHash, CrossFadeDuartion);
    }
